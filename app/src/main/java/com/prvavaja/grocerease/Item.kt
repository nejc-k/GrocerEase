...
@Serializable
class Item(var itemName:String,var store:String,var amount:String, var checked:Boolean = false) {//konstruktor
    ...
    override fun toString(): String {
        return "item, Name: "+itemName + "UUID: " + uuid +" Store: "+ store+" Amaunt: "+amount + " Checked: "+checked.toString()
    }
